...
class Book {
    ...
    displayBook(){
        ...
        numCopiesElement.innerText = this.numCopies;
...
// const book1 = new Book(book1Element, "Crying in H-Mart", "Dora Do", 10);
// console.log(book1);
// book1.displayBook();
...
for (let i = 0; i < books.length; i++){
    const book1Element = document.createElement('div');
    LibraryElement.appendChild(book1Element);
    const book1 = new Book(book1Element, books[i].name, books[i].author, books[i].numOfCopies );
    book1.displayBook();
    console.log(book1);
}
